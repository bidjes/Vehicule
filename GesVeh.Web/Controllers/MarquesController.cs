...
namespace GesVeh.Web.Controllers
{
    public class MarquesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nom,CreateBy,ModifiedBy,DeleteBy,CreationDate,ModificationDate,DeletationDate,Delete")] Marque marque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nom,CreateBy,ModifiedBy,DeleteBy,CreationDate,ModificationDate,DeletationDate,Delete")] Marque marque)
        {
            if (ModelState.IsValid)
            {
